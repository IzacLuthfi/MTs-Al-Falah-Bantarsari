...
export default function SidebarSiswa() {
  ...
  const menuItems = [
    { name: "Dashboard", href: "/dashboard/siswa", icon: Home },
    { name: "Biodata Saya", href: "/dashboard/siswa/biodata", icon: User },
    { name: "Jadwal Pelajaran", href: "/dashboard/siswa/jadwal", icon: Calendar },
    { name: "Nilai & Rapor", href: "/dashboard/siswa/nilai", icon: BookOpen },
  ];
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-slate-200 bg-white text-slate-900 md:block hidden z-50">
      <div className="flex h-16 items-center border-b border-slate-200 px-6">
        <span className="text-xl font-bold text-blue-600">Portal Siswa</span>
      </div>
